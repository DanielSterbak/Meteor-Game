...
public class ScreenWrap : MonoBehaviour {
    ...
    void WrapSprite() {
        ...
        Vector3 viewportPosition = mainCamera.WorldToViewportPoint(spritePosition);
    ...
    void WrapToOppositeSide(Vector3 viewportPosition) {
        ...
        Vector3 newWorldPosition = mainCamera.ViewportToWorldPoint(new Vector3(newX, newY, viewportPosition.z));
